...
const Profile1 = (props) => {
  return (
    <div className="profile1-container">
      <Helmet>
        <title>
          Profile1 - Merkaba Mushrooms - Medicinal Mushrooms Tinctures
        </title>
        <meta
          property="og:title"
          content="Profile1 - Merkaba Mushrooms - Medicinal Mushrooms Tinctures"
        />
      </Helmet>
      ...
      <div className="profile1-profile">
        ...
        <div className="profile1-container01">
          <div className="profile1-container02">
            <h4 className="profile1-text">Jordan Gros</h4>
            <OutlineBlueButton button="follow"></OutlineBlueButton>
          </div>
          <div className="profile1-container03">
          ...
          <div className="profile1-container05">
            <div className="profile1-card">
              <div className="profile1-container06">
                ...
                <div className="profile1-container07">
              ...
              <div className="profile1-container08"></div>
            </div>
          </div>
        </div>
      </div>
      <div className="profile1-contact">
        <div className="profile1-container09">
          <div className="profile1-form">
            <h2 className="profile1-text18 HeadingOne">
              <span>Say Hi!</span>
            </h2>
            <span className="profile1-text20 Lead">
              We&apos;d like to talk with you.
            </span>
            <form className="profile1-form1">
              <label className="profile1-text21 Label">My name is</label>
              <input
                type="text"
                placeholder="Full Name"
                className="profile1-textinput Small input"
              />
              <label className="profile1-text22 Label">
                I&apos;m looking for
              </label>
              <input
                type="text"
                placeholder="What you love"
                className="profile1-textinput1 input Small"
              />
              <label className="profile1-text23 Label">Your message</label>
              <textarea
                rows="8"
                placeholder="I want to say that..."
                className="profile1-textarea Small textarea"
              ></textarea>
            </form>
            <div className="profile1-container10">
              <div className="profile1-container11">
                <PrimaryBlueButton button="send message"></PrimaryBlueButton>
              </div>
            </div>
          </div>
          <div className="profile1-info">
            <div className="profile1-container12">
              ...
              <span className="profile1-text27">
                Fill up the form and our Team will get back to you within 24
                hours.
              </span>
              <div className="profile1-container13">
                <div className="profile1-container14">
                  <svg viewBox="0 0 1024 1024" className="profile1-icon02">
                  ...
                  <a href="tel:+40 772 100 200" className="profile1-link Small">
                    (+40) 772 100 200
                  </a>
                </div>
                <div className="profile1-container15">
                  <svg viewBox="0 0 1024 1024" className="profile1-icon04">
                    <path d="M854 342v-86l-342 214-342-214v86l342 212zM854 170q34 0 59 26t25 60v512q0 34-25 60t-59 26h-684q-34 0-59-26t-25-60v-512q0-34 25-60t59-26h684z"></path>
                  </svg>
                  <a
                    href="mailto:hello@creative-tim.com?subject="
                    className="profile1-link1 Small"
                  >
                    hello@creative-tim.com
                  </a>
                </div>
                <div className="profile1-container16">
                  <svg viewBox="0 0 1024 1024" className="profile1-icon06">
                    <path d="M512 490q44 0 75-31t31-75-31-75-75-31-75 31-31 75 31 75 75 31zM512 86q124 0 211 87t87 211q0 62-31 142t-75 150-87 131-73 97l-32 34q-12-14-32-37t-72-92-91-134-71-147-32-144q0-124 87-211t211-87z"></path>
                  </svg>
                  <span className="profile1-text28 Small">
                    Dyonisie Wolf Bucharest, RO 010458
                  </span>
                </div>
              </div>
              <div className="profile1-container17">
                <svg
                  viewBox="0 0 877.7142857142857 1024"
                  className="profile1-icon08"
                >
                  <path d="M713.143 73.143c90.857 0 164.571 73.714 164.571 164.571v548.571c0 90.857-73.714 164.571-164.571 164.571h-107.429v-340h113.714l17.143-132.571h-130.857v-84.571c0-38.286 10.286-64 65.714-64l69.714-0.571v-118.286c-12-1.714-53.714-5.143-101.714-5.143-101.143 0-170.857 61.714-170.857 174.857v97.714h-114.286v132.571h114.286v340h-304c-90.857 0-164.571-73.714-164.571-164.571v-548.571c0-90.857 73.714-164.571 164.571-164.571h548.571z"></path>
                </svg>
                <svg
                  viewBox="0 0 950.8571428571428 1024"
                  className="profile1-icon10"
                >
            ...
            />
            <div className="profile1-container18"></div>
          </div>
        </div>
      </div>
      <Footer></Footer>

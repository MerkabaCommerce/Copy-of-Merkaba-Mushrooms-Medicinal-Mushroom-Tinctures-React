  ...
  return (
    <>
      <div className="home-container">
            ...
            <div className="home-card">
              ...
              <div className="home-container04">
                <div className="home-container05">
                  <a
                    href="https://merkaba-mushrooms-next-js.vercel.app/shop#!/"
                    target="_blank"
          ...
          <div className="home-container06">
            <div className="home-container07">
              <div className="home-container08">
                ...
                <p className="home-text08 Lead">
                  <span className="home-text09">
                    Whatever your qualification is - we got you!
                  </span>
                </p>
                <p className="home-text10 Body">
                ...
                <p className="home-text12">Mark Jojansen</p>
                <p className="home-text13 Small">Project manager, Atlassian</p>
        ...
        <section className="home-container24">
          <div className="home-container25">
            ...
            <h2 className="home-text14 HeadingTwo">
              <span className="home-text15">Beware The Components</span>
            </h2>
            <h3 className="home-text16 HeadingTwo">
              <span className="home-text17">How To Handle Them</span>
              <br></br>
            </h3>
          ...
          <div className="home-container27">
            <div className="home-container28">
              ...
              <div className="home-container30">
                ...
                <h1 className="home-text20 HeadingOne">Search and Discover!</h1>
          ...
          <div className="home-container32">
            ...
            <div className="home-container34">
              ...
              <div className="home-container36">
                ...
                <h1 className="home-text24 HeadingOne">Talk and Meet!</h1>
